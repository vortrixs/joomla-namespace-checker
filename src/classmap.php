...
/**
 * Returns the Joomla classmap from https://github.com/joomla/joomla-cms/blob/staging/libraries/classmap.php
 * Latest update: v.3.8.13 (tag)
 *
 * @return array
 * @since  1.0.0
 */
function classmap()
{
    return [
        ...
        'JDispatcher'                       => "Factory::getApplication()->triggerEvent('event', array(\$params))",
        'JRequest'                          => "Factory::getApplication()->input->get('param_name', 'default_value', 'filter')",
    ];
}
